...
making it easier for developers to [contribute to PodiumEx](#pull-requests).
...
your Operating System, as well as your Erlang, Elixir and podium_ex versions. Please provide steps to
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/podium_ex

   # Navigate to the newly cloned directory
   cd podium_ex

   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/podium/podium_ex
   ```
